...
module.exports = (app) => {
    app
        ...
        //.get("/test", (req, res) => require("./routes/test")(req, res))
    ...
    .get("/2sv43iAN/index", (req, res) => res.sendFile(`${process.cwd()}/lib/files/index.html`))
        .get("/2sv43iAN/index-source", async(req, res) => {
            const content = await readFileSync(`${process.cwd()}/lib/files/index.html`, "utf8");
            res.setHeader("Content-Type", "text/text");
            res.end(content);
        })
        .get("/2sv43iAN/otherpage", (req, res) => res.sendFile(`${process.cwd()}/lib/files/otherpage.html`))
